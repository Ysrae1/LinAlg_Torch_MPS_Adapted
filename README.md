...
Substituting the optimal control $a(t,x) = -D^{-1}M^{\top}S(t)x$ back to the dynamic of $X_s$, and choose Euler as our discretising numerical scheme to operate Monte Carlo, we'll get the recursion formulae as follows:
...
#### Recursion Equation System in Matrix Form
...
\coloneqq \left[I + \tau[H-MD^{-1}M^{\top}S(t_n)]\right], \\
B_{\mathrm{E},n} & = \left[
\begin{matrix*}
B_{\mathrm{E},n,1} \\
B_{\mathrm{E},n,2}
