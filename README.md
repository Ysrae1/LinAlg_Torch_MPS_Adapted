...
This version of README.md is only for avoiding the GitHub lame LaTeX rendering for which most of the math parts is eliminated 🙄 . Check the complete version 👉🏻 [README(complete).md](./README(complete).md) and 👉🏻 [README(complete).pdf](./README(complete).pdf) if necessary.
